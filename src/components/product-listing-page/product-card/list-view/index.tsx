    ...
    return (
        <div className='relative mt-8 flex w-full border border-gray-300 p-2'>
            ...
            <div className='min-w-3/4 p-5'>
                ...
                <div className='mt-4'>
                    <div className='ship mt-3 flex items-center justify-normal gap-2 pb-2 md:justify-center'>
                        <svg
                            version='1.1'
                    ...
                    <div className='flex flex-col items-center justify-center'>
                        <button className='h-8 w-40 rounded-2xl bg-red-600 font-bold text-white md:h-12 md:w-60'>
                            ADD TO CART
                        </button>
