...
const QuickShipInfo: React.FC<ProductCardProps> = ({ product }) => {
    return (
        <div className='ship mt-3 flex items-center gap-2 pb-2'>
            {!product?.isBackOrder ? (
            ...
            <div>
                {product?.isBackOrder ? (
                    <div>
                        <p className='text-sm font-extrabold text-black italic'>ON BACKORDER</p>
                        <p className='text-xs text-black'>Call for availability</p>
                    </div>
                ) : (
                    <div>
