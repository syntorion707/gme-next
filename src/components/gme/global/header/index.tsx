        ...
        <>
            ...
            <div className='px-4 md:hidden'>
                <div className='relative w-full'>
                    ...
                    />
                    <button className='bg-primary absolute top-0 right-0 bottom-0 px-4 text-white'>
                        {' '}
            ...
            <div className='border-primary hidden cursor-pointer justify-around gap-4 border-t-2 bg-black px-6 py-2 text-white md:flex'>
