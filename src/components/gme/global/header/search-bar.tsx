    ...
    return (
        <div
            ...
            <div className='flex w-full justify-center'>
                {isMobile ? (
                    <div className='xs:w-[337px] relative h-[44px] overflow-hidden border border-gray-300 bg-white text-sm text-gray-700 placeholder-gray-500 shadow-sm outline-none min-[320px]:w-[288px] sm:w-[383px] md:w-[546px] lg:w-[343px] xl:w-[670px] 2xl:w-[670px]'>
